 ...
 * @create date 2020-02-18 17:09:23
 * @modify date 2020-02-18 17:09:23
 * @desc [description]
 */
...
void PopUp::paintEvent(QPaintEvent* event) {
    ...
    painter.setBrush(QBrush(QColor(0, 0, 200, 180)));
...
void PopUp::show() {
    ...
    animation.setDuration(500);    // Configuring the duration of the animation
...
float PopUp::getPopupOpacity() const { return popupOpacity; }